...
export type UpdateTutorialBodyCategory =
  (typeof UpdateTutorialBodyCategory)[keyof typeof UpdateTutorialBodyCategory];
...
export type GetTutorial200Category =
  (typeof GetTutorial200Category)[keyof typeof GetTutorial200Category];
...
export type GetTutorials200ItemCategory =
  (typeof GetTutorials200ItemCategory)[keyof typeof GetTutorials200ItemCategory];
...
export type CreateTutorialBodyCategory =
  (typeof CreateTutorialBodyCategory)[keyof typeof CreateTutorialBodyCategory];
...
export type GetFiles200ItemType =
  (typeof GetFiles200ItemType)[keyof typeof GetFiles200ItemType];
...
export type UpdateReportBodyCategory =
  (typeof UpdateReportBodyCategory)[keyof typeof UpdateReportBodyCategory];
...
export type GetReports200ItemCategory =
  (typeof GetReports200ItemCategory)[keyof typeof GetReports200ItemCategory];
...
export const getGetReportsUrl = () => {
  return `http://192.168.5.23:3333/reports`;
};
...
export const getGetReportsQueryKey = () => {
  return [`http://192.168.5.23:3333/reports`] as const;
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getReports>>> = ({
    signal,
  }) => getReports({ signal, ...fetchOptions });
...
export const getGetReportUrl = (id: number) => {
  return `http://192.168.5.23:3333/report/${id}`;
};
...
export const getGetReportQueryKey = (id: number) => {
  return [`http://192.168.5.23:3333/report/${id}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getReport>>> = ({
    signal,
  }) => getReport(id, { signal, ...fetchOptions });
...
export const getCreateReportUrl = () => {
  return `http://192.168.5.23:3333/report`;
};
...
export const getGetFilesUrl = () => {
  return `http://192.168.5.23:3333/files`;
};
...
export const getGetFilesQueryKey = () => {
  return [`http://192.168.5.23:3333/files`] as const;
};
...
export const getCreateFilesUrl = (id: number) => {
  return `http://192.168.5.23:3333/files/${id}`;
};
...
export const getCreateFilesMutationOptions = <
  TError = CreateFiles500,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateFilesMutationResult = NonNullable<
  Awaited<ReturnType<typeof createFiles>>
>;
...
export const getUpdateFilesMutationOptions = <
  TError = UpdateFiles404 | UpdateFiles500,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export const getCreateTutorialUrl = () => {
  return `http://192.168.5.23:3333/tutorials`;
};

export const createTutorial = async (
  createTutorialBody: CreateTutorialBody,
  options?: RequestInit
): Promise<createTutorialResponse> => {
  const res = await fetch(getCreateTutorialUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(createTutorialBody),
  });
  const data = await res.json();
...
export const getCreateTutorialMutationOptions = <
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateTutorialMutationResult = NonNullable<
  Awaited<ReturnType<typeof createTutorial>>
>;
...
export const getGetTutorialsQueryKey = () => {
  return [`http://192.168.5.23:3333/tutorials`] as const;
};

export const getGetTutorialsQueryOptions = <
  TData = Awaited<ReturnType<typeof getTutorials>>,
  TError = unknown
>(options?: {
  query?: Partial<
    UseQueryOptions<Awaited<ReturnType<typeof getTutorials>>, TError, TData>
  >;
  fetch?: RequestInit;
}) => {
  const { query: queryOptions, fetch: fetchOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTutorials>>> = ({
    signal,
  }) => getTutorials({ signal, ...fetchOptions });
...
export type GetTutorialsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTutorials>>
>;
...
export const getGetTutorialUrl = (id: number) => {
  return `http://192.168.5.23:3333/tutorials/${id}`;
};
...
export const getGetTutorialQueryKey = (id: number) => {
  return [`http://192.168.5.23:3333/tutorials/${id}`] as const;
};

export const getGetTutorialQueryOptions = <
  TData = Awaited<ReturnType<typeof getTutorial>>,
  TError = GetTutorial404
>(
  id: number,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getTutorial>>, TError, TData>
    >;
    fetch?: RequestInit;
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTutorial>>> = ({
    signal,
  }) => getTutorial(id, { signal, ...fetchOptions });
...
export type GetTutorialQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTutorial>>
>;
...
export const updateTutorial = async (
  id: number,
  updateTutorialBody: UpdateTutorialBody,
  options?: RequestInit
  ...
  const res = await fetch(getUpdateTutorialUrl(id), {
    ...
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateTutorialBody),
  });
  const data = await res.json();
...
export const getUpdateTutorialMutationOptions = <
  TError = UpdateTutorial404,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateTutorialMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateTutorial>>
>;
...
export const deleteTutorial = async (
  id: number,
  options?: RequestInit
): Promise<deleteTutorialResponse> => {
...
export const getDeleteTutorialMutationOptions = <
  TError = unknown,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteTutorialMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteTutorial>>
>;
